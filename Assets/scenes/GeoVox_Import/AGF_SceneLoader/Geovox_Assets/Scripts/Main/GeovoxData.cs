...
{
	//[System.Serializable]
	public class GeovoxData : ScriptableObject
	{
		...
		{ 
			...
			[System.NonSerialized] public static Geovox.Matrix3<byte> setBlockMatrix = new Geovox.Matrix3<byte>(1,1024,1);
		...
		*/
		...
		public void ToMatrix (Geovox.Matrix3<byte> matrix)
		{
		...
		public Geovox.Matrix2<Column> GetColumnMatrix (int offsetX, int offsetZ, int sizeX, int sizeZ) //gets deepcopy of columns in a matrix for undo
		{
			Geovox.Matrix2<Column> matrix = new Geovox.Matrix2<Column>(sizeX,sizeZ);
		...
		{
			//getting exists matrix
			Geovox.Matrix3<byte> exists = new Geovox.Matrix3<byte>(extend*2, extend*2, extend*2);
