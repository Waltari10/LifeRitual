	...
	public class Visualizer
	{
		#region Default Voxealnd Visualization
			...
			public void  Visualize ()
			{
				...
				VoxelTerrain.AimData coordsData = land.GetCoordsByRay(aimRay);
				...
				if (showCoords)
				{
					...
					Gizmos.DrawWireCube(new Vector3(
						coordsData.x+0.5f+VoxelTerrain.oppositeDirX[coordsData.dir], 
						coordsData.y+0.5f+VoxelTerrain.oppositeDirY[coordsData.dir], 
						coordsData.z+0.5f+VoxelTerrain.oppositeDirZ[coordsData.dir]), Vector3.one);	
				}
				#endregion
				...
				GeovoxData.Area area = land.data.GetArea(coordsData.x, coordsData.z);
